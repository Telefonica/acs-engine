...
$ docker image inspect microsoft/acs-engine:0.8.0 --format "{{json .Config.Labels}}" | jq
{
  ...
  "org.label-schema.url": "https://github.com/Telefonica/acs-engine",
  "org.label-schema.usage": "https://github.com/Telefonica/acs-engine/blob/master/docs/acsengine.md",
  "org.label-schema.vcs-url": "https://github.com/Telefonica/acs-engine.git",
