...
https://github.com/Telefonica/acs-engine/blob/master/CONTRIBUTING.md
...
1. Use `go get` to clone the acs-engine repository: `go get github.com/Telefonica/acs-engine`
2. Fork that repository into your GitHub account
3. Add your repository as a remote for `$GOPATH/github.com/Telefonica/acs-engine`
